...
public class OnlineRegistrations implements Serializable, Model <OnlineRegistrations> {
	private static final long serialVersionUID = 1L;
      
	public OnlineRegistrations () {
	...
	public String toString() {
		return "OnlineRegistrations [id=" + id + ", massar_code=" + massar_code + ", ar_first_name=" + ar_first_name
