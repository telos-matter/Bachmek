                    ...
                    <c:otherwise>
                        <table>
                            <tr>
                                ...
                                <th class="th">Assessments' Element</th>
                                <th class="th">Elements' Module</th>
                                <th class="th">Coefficient</th>
                            </tr>
                            <c:forEach var="list_item" items="${list}">
                                <tr>
                                    <td>
                                        ${list_item.assessment.name}
                                    </td>
                                    <td>
                                        ${list_item.assessment.element.name}
                                    </td>
                                    <td>
                                        ${list_item.assessment.element.module.name}
                                    </td>
                                    <td>
