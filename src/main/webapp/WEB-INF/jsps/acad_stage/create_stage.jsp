...
<html>
        <head>
                ...
                <title>${estm_name} - Create Academic Stage</title>
                <style>
                    #form_statement {
                        margin-left: auto;
                        margin-right: auto;
        ...
        <body>
                ...
                <p id="form_statement">Create a new Academic Stage for the ${major.major} Major</p>
                <form action="${pageContext.request.contextPath}/acadStage/create?major_id=${major.id}" method="post">
                    ...
                    <div class="input_form">
                        <c:choose>
                            <c:when test="${not major.isActive}">
                                <label>Active</label>
                    ...
                    <div class="input_form">
                        ...
                        <label for="create">Automatically create two Academic Semesters</label>
                    </div>
