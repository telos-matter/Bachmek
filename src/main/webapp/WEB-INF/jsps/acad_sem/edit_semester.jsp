...
<html>
        <head>
                ...
                <title>${estm_name} - Edit Academic Semester</title>
                <style>
                    #form_statement {
                        margin-left: auto;
                        margin-right: auto;
        ...
        <body>
                ...
                <p id="form_statement">Edit the ${item.sequence} Acad. Sem. from the ${item.academicStage.sequence} Acad. Stage</p>
                <form action="${pageContext.request.contextPath}/acadSem/edit?id=${item.id}" method="post">
                    ...
                    <div class="input_form">
                        <c:choose>
                            <c:when test="${not item.academicStage.isActive}">
                                <label>Active</label>
