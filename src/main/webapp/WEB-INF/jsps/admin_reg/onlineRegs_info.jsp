...
<html>
        <head>
                ...
                <title>${estm_name} - Online Registrations</title>
                <style>
                    header {
                        display: flex;
        ...
        <body>
                ...
                <header>
                    <p id="main_title" class="g_h_clr">${item.fullName} Online. Regs. information</p>
                    <a href="${pageContext.request.contextPath}/adminReg/onlineRegs/delete?id=${item.id}">
