...
<html>
        ...
        <body>
                ...
                <header>
                    <a href="${pageContext.request.contextPath}/element/create?module_id=${item.id}">
                    ...
                    <p id="main_title" class="g_h_clr"><a class="g_h_clr" href="${pageContext.request.contextPath}/module/list?hidden=${hidden}">${item.name}</a> elements</p>
                    <c:choose>
                        <c:when test="${hidden}">
                            <a href="${pageContext.request.contextPath}/module?id=${item.id}&hidden=0">
                                <img class="icon" src="${pageContext.request.contextPath}/resources/images/icons/hidden_icon.png" alt="Hidden icon" title="Show inactive elements as well" width="32" height="32">
                            </a>
                        </c:when>
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/module?id=${item.id}&hidden=1">
                                <img class="icon" src="${pageContext.request.contextPath}/resources/images/icons/visible_icon.png" alt="Visible icon" title="Show only active elements" width="32" height="32">
                            </a>
                        </c:otherwise>
                    </c:choose>
                    <a href="${pageContext.request.contextPath}/module/edit?id=${item.id}">
                        ...
                        <c:otherwise>
                            <table>
                                ...
                                <c:forEach var="list_item" items="${list}">
                                    <tr>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/element?id=${list_item.id}&hidden=${hidden}">
                                                ${list_item.name}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/element/edit?id=${list_item.id}">
                                                <img class="icon" src="${pageContext.request.contextPath}/resources/images/icons/edit_icon.png" alt="Edit icon" width="32" height="32">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/assessment/create?element_id=${list_item.id}">
