...
<html>
        <head>
                ...
                <title>${estm_name} - Create Assessment</title>
                <style>
                    .error_message {
                        font-size: x-large;
                        margin: auto;
        ...
        <body>
                ...
                <p id="form_statement">Create a new Assessment for the ${element.name} Element</p>
                <form action="${pageContext.request.contextPath}/assessment/create?element_id=${element.id}" method="post">
                    ...
                    <div class="input_form">
                        <c:choose>
                            <c:when test="${not element.isActive}">
                                <label>Active</label>
