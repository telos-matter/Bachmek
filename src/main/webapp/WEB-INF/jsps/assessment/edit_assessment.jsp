...
<html>
        <head>
                ...
                <title>${estm_name} - Edit Assessment</title>
                <style>
                    .error_message {
                        font-size: x-large;
                        margin: auto;
        ...
        <body>
                ...
                <p id="form_statement">Edit the ${item.name} Assessment from the ${item.element.name} Element</p>
                <form action="${pageContext.request.contextPath}/assessment/edit?id=${item.id}" method="post">
                    ...
                    <div class="input_form">
                        <c:choose>
                            <c:when test="${not item.element.isActive}">
                                <label>Active</label>
