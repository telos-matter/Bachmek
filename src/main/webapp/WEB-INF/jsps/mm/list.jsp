                        ...
                        <table>
                            ...
                            <c:forEach var="list_item" items="${list}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/mm/download?acadYear_id=${acadYear.id}&type=${type}&id=${list_item.id}" target="_blank">
                                            <img class="icon" src="${pageContext.request.contextPath}/resources/images/icons/download_icon.png" alt="Download icon" width="32" height="32">
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
